...
export default function Home() {
  ...
  return (
    <main className="bg-[url('/images/bg-main.svg')] bg-cover min-h-screen flex flex-col">
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-800 bg-[#0a0a0a]/80 backdrop-blur-xl mt-20">
            ...
            <div className="flex flex-col items-center md:items-start gap-3">
              <div className="flex items-center gap-2 mt-2">
                ...
                <a 
                  ...
                  className="text-white hover:text-neutral-300 transition-colors font-semibold"
                >
                  Puter.js
                </a>
              </div>
            ...
            <div className="flex flex-col items-center md:items-end gap-4">
              <div className="flex flex-row gap-6 items-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group text-neutral-400 hover:text-white transition-all duration-300"
